...
//	}
	// if()
		...
		/*
		 * if(yearDiff<0){ //next button
		 * 
		 * 
		 * System.out.println("Less Year Diff->");
		 * 
		 * driver.findElement(By.xpath(
		 * "//*[@id=\"book-appointment\"]/descendant::div[@class='vdp-datepicker__calendar'][4]/header/span[3]"
		 * )).click(); yr =driver.findElement(By.xpath(
		 * "//*[@id=\"book-appointment\"]/descendant::div[@class='vdp-datepicker__calendar'][4]/header/span[2]"
		 * )).getText(); yearDiff = Integer.parseInt(yr.substring(0,
		 * 4))-Integer.parseInt(year); }
		 * 
	...
	//	}
		...
		driver.findElement(By.xpath("//div[@class='vdp-datepicker']/parent::div[@class='form-group']//span[starts-with(@class,'cell day')][text()='"+day+"']")).click();
